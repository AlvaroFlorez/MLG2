...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X }\OtherTok{=} \FunctionTok{model.matrix}\NormalTok{(mod.fat)[,}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{]}
\NormalTok{lasso.mod }\OtherTok{\textless{}{-}} \FunctionTok{glmnet}\NormalTok{(X, fat}\SpecialCharTok{$}\NormalTok{brozek, }\AttributeTok{alpha =} \DecValTok{1}\NormalTok{,}\AttributeTok{nlambda =} \DecValTok{100}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(lasso.mod,}\AttributeTok{xvar=}\StringTok{\textquotesingle{}lambda\textquotesingle{}}\NormalTok{,}\AttributeTok{label=}\NormalTok{T,}\AttributeTok{lwd=}\DecValTok{2}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h=}\DecValTok{0}\NormalTok{,}\AttributeTok{lty=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lasso.cv }\OtherTok{\textless{}{-}}\FunctionTok{cv.glmnet}\NormalTok{(X, fat}\SpecialCharTok{$}\NormalTok{brozek, }\AttributeTok{nfolds =} \DecValTok{252}\NormalTok{, }\AttributeTok{alpha =} \DecValTok{1}\NormalTok{,}\AttributeTok{nlambda =} \DecValTok{100}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(Puromycin}\SpecialCharTok{$}\NormalTok{conc,Puromycin}\SpecialCharTok{$}\NormalTok{rate,}\AttributeTok{col=}\NormalTok{Puromycin}\SpecialCharTok{$}\NormalTok{state,}
     \AttributeTok{xlab=}\StringTok{\textquotesingle{}concentración de sustrato (ppm)\textquotesingle{}}\NormalTok{,}
     \AttributeTok{ylab=}\StringTok{\textquotesingle{}velocidad de reacción\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Puromycin}\SpecialCharTok{$}\NormalTok{state2 }\OtherTok{=} \FunctionTok{as.double}\NormalTok{(Puromycin}\SpecialCharTok{$}\NormalTok{state }\SpecialCharTok{==} \StringTok{\textquotesingle{}treated\textquotesingle{}}\NormalTok{)}
\NormalTok{mod }\OtherTok{=} \FunctionTok{nls}\NormalTok{(rate }\SpecialCharTok{\textasciitilde{}}\NormalTok{ (th1}\SpecialCharTok{*}\NormalTok{conc }\SpecialCharTok{+}\NormalTok{ th3}\SpecialCharTok{*}\NormalTok{conc}\SpecialCharTok{*}\NormalTok{state2)}\SpecialCharTok{/}\NormalTok{(th2}\SpecialCharTok{+}\NormalTok{th4}\SpecialCharTok{*}\NormalTok{state2}\SpecialCharTok{+}\NormalTok{conc),}\AttributeTok{data =}\NormalTok{ Puromycin,}
          \AttributeTok{start =} \FunctionTok{list}\NormalTok{(}\AttributeTok{th1=}\DecValTok{168}\NormalTok{,}\AttributeTok{th2=}\FloatTok{0.4}\NormalTok{,}\AttributeTok{th3=}\DecValTok{0}\NormalTok{,}\AttributeTok{th4=}\DecValTok{0}\NormalTok{),}\AttributeTok{trace=}\NormalTok{F )}
\FunctionTok{summary}\NormalTok{(mod)}
\end{Highlighting}
\end{Shaded}
